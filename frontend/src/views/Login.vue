<template><div class="login"><div class="card"><h1>航天器健康管理平台</h1><el-form :model="form" @submit.prevent="submit"><el-form-item><el-input v-model="form.username" placeholder="用户名"/></el-form-item><el-form-item><el-input v-model="form.password" type="password" placeholder="密码"/></el-form-item><el-button type="primary" native-type="submit" :loading="loading">登录系统</el-button></el-form><small>用户账号由管理员创建</small></div></div></template>
<script setup>
