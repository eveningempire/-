...
import { msfgMethods, nodePanelList, subsystemInit } from './msfgDetail/msfgMethods.mjs'
import { importStruct, exportStruct, renderStructColor } from './msfgDetail/common/methods.mjs'
