...
class Predictor:
    ...
    def process_datadf(cmg_type, cmg_target_cols, data_df, window_size=64, step=64, n_components=3):
        ...
        try:
            ...
            # 濡傛灉妯＄硦鍖归厤澶辫触锛屼娇鐢ㄥ師濮嬬被鍨嬶紙鍚戝悗鍏煎锛?            matched_cmg_type = cmg_type
    ...
    def calc_rul_weighted(
        ...
        # 馃敡 淇锛氫娇鐢ㄧ伒娲荤殑鏃堕棿鎴宠В鏋愶紝涓巗trategy0淇濇寔涓€鑷?        timestamp_start = utils.parse_timestamp_flexible(time_stamps.iloc[0])
    ...
    def predict_batch(
        ...
        try:
            matched_cmg_type = utils.fuzzy_match_cmg_type(cmg_type)
            print(f"[Strategy1] PHM鍨嬪彿妯＄硦鍖归厤: '{cmg_type}' -> '{matched_cmg_type}'")
