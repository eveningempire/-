...
if __name__ == "__main__":
    ...
    cmg_type_params_map = {
        ...
        "5000NMS": {"time_start_use": "2020_10_09_14:53:12", "time_fmt": "%Y_%m_%d_%H:%M:%S"},
    }
    retrain = False  # 鏄惁閲嶆柊璁粌妯″瀷
    # 鍙€夌殑绛栫暐缁勫悎
    strategies = [
        # "Original",
        "Strategy1-VAE",
    ...
    if retrain:
        ...
        if "Strategy1-VAE" in strategies:
        ...
        if "Strategy2-IForest" in strategies:
        ...
        if "Strategy3-SOM" in strategies:
