...
def get_model_params(cmg_type: str, target_cols: list):
    MODEL_PATH = BASE_DIR / "strategy2" / "models" / cmg_type / "isof_model.pkl"
    SCALERS_PATH = BASE_DIR / "strategy2" / "scalers" / cmg_type / "scalers.pkl"
    SVD_SCALER_PATH = BASE_DIR / "strategy2" / "scalers" / cmg_type / "svd_scaler.pkl"
    # 鍔犺浇褰掍竴鍖栧櫒
