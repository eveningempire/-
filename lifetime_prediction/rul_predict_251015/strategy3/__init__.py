...
from strategy3.model import SOM as SOM
...
def get_model_params(cmg_type: str, target_cols: list):
    MODEL_PATH = BASE_DIR / "strategy3" / "models" / cmg_type / "som_model.pkl"
    SCALERS_PATH = BASE_DIR / "strategy3" / "scalers" / cmg_type / "scalers.pkl"
    SVD_SCALER_PATH = BASE_DIR / "strategy3" / "scalers" / cmg_type / "svd_scaler.pkl"
    # 鍔犺浇褰掍竴鍖栧櫒
